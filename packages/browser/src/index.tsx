...
// Export spectrogram computation and utilities
export { computeSpectrogram, computeSpectrogramMono, getColorMap, getFrequencyScale } from './spectrogram';
export type { FrequencyScaleName } from './spectrogram';
